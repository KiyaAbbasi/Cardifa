...
class bio_search extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__('جستجو', BIO_PLUGIN_NAME);
    }
    ...
    protected function register_content_section_1(){
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'popup',
                'options' => [
                    'popup'  => esc_html__( 'Popup', BIO_PLUGIN_NAME ),
                    'inline' => esc_html__( 'Inline', BIO_PLUGIN_NAME ),
                ],
            ]
        );
                ...
                <div class="popup-search-container">
                    ...
                    <div class="popup-search-content">
                        <div class="popup-search-title-wrapper">
                            <h3><?php esc_html_e('Type and hit Enter to search', BIO_PLUGIN_NAME); ?></h3>
                        </div>
                        <div class="popup-search-form-wrapper">
                            <form action="<?php echo home_url('/'); ?>" method="get" class="popup-search-form">
                                <input type="text" name="s" value="" class="search-field" placeholder="<?php esc_html_e('Search ...', BIO_PLUGIN_NAME); ?>" aria-label="Search" required>
