...
class socials_bio extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'اجتماعی', BIO_PLUGIN_NAME );
    }
	...
	protected function register_content_section_3() {
		...
		$this->start_controls_tabs( 'btn-style' );
		...
		$this->register_text_style( 'name', '.name', $algin = false );

		$this->add_control(
			'icon_1_heading',
			[ 
				'label' => esc_html__( 'first icon', BIO_PLUGIN_NAME ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);

		$this->register_text_style( 'icon', '.icon-1', $algin = false );
		...
		$this->register_text_style( 'icon2', '.icon-2', $algin = false );
		...
		$this->register_container_style( 'container-hover', 'a.social-item:hover' );
		...
		$this->register_text_style( 'name-hover', 'a.social-item:hover .name', $algin = false );

		$this->add_control(
			'icon_1_heading-hover',
			[ 
		...
		$this->register_text_style( 'icon-hover', 'a.social-item:hover .icon-1', $algin = false );

		$this->add_control(
			'icon_2_heading-hover',
			[ 
				'label' => esc_html__( 'ایکون دوم', BIO_PLUGIN_NAME ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
		...
		$this->register_text_style( 'icon2-hover', 'a.social-item:hover .icon-2', $algin = false );

		$this->add_control(
			'first_image_hover_heading',
			[ 
				'label' => esc_html__( 'تصویر اول', BIO_PLUGIN_NAME ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
		...
		$this->register_image_style( 'first_image_style_hover', 'a.social-item:hover .first-image' );

		$this->add_control(
			'sec_image_hover_heading',
			[ 
				'label' => esc_html__( 'تصویر دوم', BIO_PLUGIN_NAME ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
		...
		$this->register_image_style( 'sec_image_style_hover', 'a.social-item:hover .sec-image' );
