...
class socials_bio_2 extends \Elementor\Widget_Base {
    ...
    public function get_name() {
        return 'socials_bio_2';
    }

    public function get_title() {
        return esc_html__( 'شبکه های اجتماعی 2', BIO_PLUGIN_NAME );
    }
	...
	protected function register_content_section_3() {
		...
		$this->register_text_style( 'name-2', '.name-2', $algin = false );
		...
		$this->register_text_style( 'icon-2', '.icon-2', $algin = false );
                     ...
                     foreach ( $settings['socials_item'] as $index => $item ) :
                        ...
                        <div class="<?php echo esc_html($post_item_cls); ?>">
                            <article <?php post_class( array( 'post-wrapper', 'cart-hover-' . $settings['hover'] ) ); ?>>
                                <a href="<?php echo esc_url( $item['link']['url'] ); ?>" class="social-item d-flex flex-column justify-content-between align-items-center">
									...
									<div class="d-flex flex-row justify-content-center align-items-center">
										...
										<div class="icon-2 d-flex align-items-center justify-content-center justify-content-between">
