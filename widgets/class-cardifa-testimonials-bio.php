...
class testimonials_bio extends \Elementor\Widget_Base {
    ...
    public function get_name() {
        return 'testimonials_bio';
    }

    public function get_title() {
        return esc_html__( 'نظرات', BIO_PLUGIN_NAME );
    }
	...
	protected function register_style_section_1(){
		...
		$this->register_text_style( 'description-avatar', '.description-avatar' );
                ...
                <?php
					foreach ( $settings['testimonials_bio'] as $index => $item ) :
                        ...
                        <div class="<?php echo esc_html($post_item_cls); ?>">
                            <article class="cart-hover-<?php echo $settings['hover']; ?> d-flex flex-column align-items-center" >
                                <div class="img"><img src="<?php echo esc_url( $item['avatar-image']['url'] ); ?>"></div>
								<p class="name"><?php echo esc_html( $item['avatar_name'] ); ?></p>
								<p class="description-avatar"><?php echo esc_html( $item['description-avatar'] ); ?></p>
								<p class="description"><?php echo esc_html( $item['avatar-desc'] ); ?></p>
                            </article>
                        </div>
                    <?php
				    endforeach; ?>
