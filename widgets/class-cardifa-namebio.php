...
class name_bio extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'نام', BIO_PLUGIN_NAME );
	}
	...
	protected function register_content_section_1() {
		...
		$this->add_control(
			'button-image',
			[ 
				'label' => esc_html__( 'تصویر دکمه', BIO_PLUGIN_NAME ),
				'type' => \Elementor\Controls_Manager::MEDIA,
			]
		);
	...
	protected function register_style_section_2() {
		...
		$this->register_image_style( 'img', '.avatar-img');
	...
	protected function register_style_section_5() {
		...
		$this->register_text_style( 'name-detail', '.name-detail p' );
	...
	protected function register_style_section_8() {
		...
		$this->register_image_style( 'btn-image', '.btn-image' );
	...
	protected function render() {
		...
		?>
		<div class="name-top d-flex flex-column align-items-center">
			...
			<a href="<?php echo urldecode( $settings['link']['url'] ); ?>" class="resume d-flex flex-row align-items-center">
				<?php echo esc_html( $settings['btn_title'] ); ?>
				<?php \Elementor\Icons_Manager::render_icon( $settings['icon'], [ 'aria-hidden' => 'true' ] ); ?>
				<?php if($settings['button-image']['url']) {
				?>
					<img class="btn-image" src="<?php echo esc_url( $settings['button-image']['url'] ); ?>">
				<?php
				}
				?>
			</a>
